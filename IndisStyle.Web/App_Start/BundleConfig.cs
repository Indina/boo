    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/libs",
                ...
                "~/Scripts/plugins/quicksand/jquery.quicksand.js",
                "~/Scripts/plugins/clingify/jquery.clingify.min.js",
                "~/Scripts/plugins/quicksand/jquery.quicksand.js",
                "~/Scripts/script.js"
            ...
            bundles.Add(new StyleBundle("~/Styles/css")
                .Include(
                    ...
                    "~/Scripts/plugins/clingify/clingify.css",
            ...
            // DASHBOARD CSS
            bundles.Add(new StyleBundle("~/Styles/dashboard/css")
                .Include(
                    "~/Content/bootstrap/bootstrap.css",
                    "~/Content/css/font-awesome.css",
                    "~/Content/dashboard/dashboard.css",
                    "~/Content/dashboard/dashboard-custom.css"
            ...
            // DASHBOARD JS
            bundles.Add(new ScriptBundle("~/bundles/dashboard/libs",
                    "//ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js")
                .Include(
